...
if __name__ == "__main__":
    ...
    parser.add_argument('--parameters_path', type=str, default='elastix-parameters/Par0003', help='root dir for elastix parameters.')
    ...
    with open(os.path.join(args.exp_output, 'elastix_transformix.bat'), 'w') as file:
        ...
        for e_path, i_path, e_seg_path, i_seg_path in zip(exhale_volumes, inhale_volumes, exhale_seg, inhale_seg):
            ...
            transform_path = f'{args.exp_output}/images/output_{i_filename_full}/{e_filename_full}/TransformParameters.{len(parameters)-1}.txt'
